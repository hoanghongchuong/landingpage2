	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
										...
										<input type="number" name="numb" value="{{$data->numb}}" class="form-control">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Lương</label>
										<input type="text" name="luong" value="{{$data->luong}}" class="form-control">
									</div>
									<div class="form-group">
										<label>Ngày tuyển</label>
										<input type="text" name="ngaytuyen" value="{{$data->ngaytuyen}}" class="form-control">
									</div>								
								</div>								
							</div>
							<div class="row">
