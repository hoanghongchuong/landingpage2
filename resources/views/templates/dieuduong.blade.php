    ...
    <div class="vk-breadcrumb">
        <nav class="container">
            <ul class="vk-list vk-list-inline vk-breadcrumb__list">
                ...
                <li class="vk-list__item active">Điều dưỡng</li>
            </ul>
        </nav>
    </div>
                    ...
                    <div class="col-lg-12 _item">
                        <div class="vk-news-item vk-news-item--first">
                            ...
                            <div class="vk-news-item__brief">
                                ...
                                <a href="{{url('dieu-duong/'.$item->alias.'.html')}}" title="{{$item->name}}" class="vk-btn vk-btn--link vk-news-item__btn">Đọc tiếp &nbsp; <i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div> <!--./vk-news-item-->
                    </div>
                    @endforeach
