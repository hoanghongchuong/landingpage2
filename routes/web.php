...
Route::get('tin-tuc-su-kien',['as'=>'getNews', 'uses'=>'IndexController@getNews']);
Route::get('tin-tuc-su-kien/{id}.html',['as'=>'getNewsDetail', 'uses'=>'IndexController@getNewsDetail']);
Route::get('tin-tuc-su-kien/{id}',['as'=>'getListNews', 'uses'=>'IndexController@getListNews']);

Route::get('dieu-duong', 'IndexController@dieuduong');
Route::get('dieu-duong/{alias}.html', 'IndexController@getdieuduong');
Route::get('vi-sao-chon-chung-toi', 'IndexController@choose');
Route::get('chuong-trinh-dich-vu', 'IndexController@chuongtrinh');
Route::get('chuong-trinh-dich-vu/{alias}.html', 'IndexController@detailchuongtrinh');
...
Route::get('tin-tuyen-dung',['as'=>'getProduct', 'uses'=>'IndexController@getProduct']);
Route::get('tin-tuyen-dung/{alias}.html','IndexController@getProductDetail')->name('detailProduct');
Route::get('tin-tuyen-dung/{id}',['as'=>'getProductList', 'uses'=>'IndexController@getProductList']);
